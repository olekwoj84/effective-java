...
public class FunctionalInterfacesTest {
    ...
    public void example(String input) {
        assertThat(input.toLowerCase()).isEqualTo(input.toUpperCase().toLowerCase() );
    }*/

    @Property
    public void l1_toConstant() {
        assertThat(L1E_FunctionalInterfaces.L1_toConstant().get()).isEqualTo(42);
    }
    ...
    public void l2_toUpperCase() {
        ...
        assertThat(L1E_FunctionalInterfaces.L2_toUpperCase().apply(input)).isEqualTo(output);
    }

    @Property
    public void l3_toLong(Long input) {
        Function<String, Long> function = L1E_FunctionalInterfaces.L3_toLong();
    ...
    public void l4_to42IntegerPredicateFalse(@InRange(minInt = 43) Integer input) {
        IntPredicate function = L1E_FunctionalInterfaces.L4_to42IntegerPredicate();
    ...
    public void l5_toIntegerPredicate(@InRange(maxInt = Integer.MAX_VALUE - 1) Integer input) {
        Function<Integer, Predicate<Integer>> function = L1E_FunctionalInterfaces.L5_toIntegerPredicate();
    ...
    public void l6_toURI() {
        ...
        assertThat(L1E_FunctionalInterfaces.L6_toURI().apply(string)).isEqualTo(uri);
    }

    @Property
    public void l7_toCallable(Integer input) throws Exception {
        Function<Supplier<Integer>, Callable<Integer>> function = L1E_FunctionalInterfaces.L7_toCallable();
    ...
    public void l8_functionComposition(@InRange(maxInt = (Integer.MAX_VALUE / 2) - 2) Integer input) {
        ...
        BinaryOperator<Function<Integer, Integer>> combiner = L1E_FunctionalInterfaces.L8_functionComposition();
